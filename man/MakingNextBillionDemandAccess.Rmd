...
ggplot(data=ITUinternet, aes(x=year, y=adoption, colour=region)) + geom_smooth(se=FALSE) 
```
...
* Alternative formulation: Interact `interface_intro` with `a_lng`: similar results
