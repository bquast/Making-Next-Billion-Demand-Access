...
adult <- rbind(adult1, adult2, adult3, adult4)
child <- rbind(child1, child2, child3, child4)
hhder <- rbind(hhder1, hhder2, hhder3, hhder4)
inder <- rbind(inder1, inder2, inder3, inder4)
hhque <- rbind(hhque1, hhque2, hhque3, hhque3)
